...

    {
        describe("Config permutations", () -> {
            ...
            it("should create default config", () -> {
                com.paulhammant.tiny.Tiny.Config config = com.paulhammant.tiny.Tiny.Config.create();
            ...
            it("should set web port", () -> {
                com.paulhammant.tiny.Tiny.Config config = com.paulhammant.tiny.Tiny.Config.create().withWebPort(8080);
                assertThat(config.inetSocketAddress.getPort(), equalTo(8080));
            });

            it("should set web socket port", () -> {
                com.paulhammant.tiny.Tiny.Config config = com.paulhammant.tiny.Tiny.Config.create().withWebSocketPort(8081);
                assertThat(config.wsPort, equalTo(8081));
            });

            it("should set web socket backlog", () -> {
                com.paulhammant.tiny.Tiny.Config config = com.paulhammant.tiny.Tiny.Config.create().withWsBacklog(100);
                assertThat(config.wsBacklog, equalTo(100));
            });

            it("should set host and web port", () -> {
                com.paulhammant.tiny.Tiny.Config config = com.paulhammant.tiny.Tiny.Config.create().withHostAndWebPort("localhost", 8080);
            ...
            it("should set web socket bind address", () -> {
                ...
                com.paulhammant.tiny.Tiny.Config config = com.paulhammant.tiny.Tiny.Config.create().withWsBindAddr(bindAddr);
                assertThat(config.wsBindAddr, equalTo(bindAddr));
            });

            it("should set socket timeout", () -> {
                com.paulhammant.tiny.Tiny.Config config = com.paulhammant.tiny.Tiny.Config.create().withSocketTimeoutMillis(60000);
